...
module.exports = function (token, orderId, callback) {
    ...
    var xmlPath = 'modules/bydesign/ordersapi/setStatusShipped.xml'

    // Parse xml file from path
    parseXmlFile(xmlPath, function(xmlObject) {
        // Envelope data
        xmlObject['soap12:Envelope']['soap12:Body'][0]['SetStatusShipped'][0]['Credentials'][0].Username = config.username
        xmlObject['soap12:Envelope']['soap12:Body'][0]['SetStatusShipped'][0]['Credentials'][0].Password = config.password
        xmlObject['soap12:Envelope']['soap12:Body'][0]['SetStatusShipped'][0]['Credentials'][0].Token = token
        xmlObject['soap12:Envelope']['soap12:Body'][0]['SetStatusShipped'][0].OrderID = orderId
